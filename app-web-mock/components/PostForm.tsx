...
export function PostForm() {
  ...
  const handleImageSelect = () => {
    ...
    const imageUrl = "https://images.unsplash.com/photo-1564349683136-77e08dba1ef7?w=500&h=300&fit=crop";
      ...
      <CardHeader className="pb-3">
        <div className="flex items-center space-x-3">
          <Avatar className="h-10 w-10">
            <AvatarImage src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=40&h=40&fit=crop&crop=face" alt="あなた" />
