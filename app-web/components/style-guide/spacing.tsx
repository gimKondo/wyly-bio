...
const radiusValues: RadiusValue[] = [
  ...
  { name: "Small", className: "rounded-sm", cssVar: "--radius-sm", value: "calc(var(--radius) - 4px)" },
  { name: "Default", className: "rounded", value: "0.25rem" },
  { name: "Medium", className: "rounded-md", cssVar: "--radius-md", value: "calc(var(--radius) - 2px)" },
  { name: "Large", className: "rounded-lg", cssVar: "--radius-lg", value: "var(--radius)" },
  { name: "Extra Large", className: "rounded-xl", cssVar: "--radius-xl", value: "calc(var(--radius) + 4px)" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {radiusValues.map((radius) => (
            <Card key={radius.name} className="p-4">
              <div className="flex items-center gap-4">
                <div
                  className={`w-16 h-16 bg-primary ${radius.className}`}
                />
                <div className="flex-1">
          ...
          <Card className="p-6">
            ...
            <div className="space-y-3">
              <div className="flex gap-2">
                ...
                <div className="bg-primary/20 p-2 rounded">Item</div>
                <div className="bg-primary/20 p-2 rounded">Item</div>
                <code className="ml-auto text-xs bg-muted px-2 py-1 rounded self-center">gap-2</code>
              </div>
              <div className="flex gap-4">
                <div className="bg-primary/20 p-2 rounded">Item</div>
                <div className="bg-primary/20 p-2 rounded">Item</div>
                <div className="bg-primary/20 p-2 rounded">Item</div>
                <code className="ml-auto text-xs bg-muted px-2 py-1 rounded self-center">gap-4</code>
              </div>
              <div className="flex gap-6">
                <div className="bg-primary/20 p-2 rounded">Item</div>
                <div className="bg-primary/20 p-2 rounded">Item</div>
                <div className="bg-primary/20 p-2 rounded">Item</div>
                <code className="ml-auto text-xs bg-muted px-2 py-1 rounded self-center">gap-6</code>
              </div>
            </div>
          </Card>
        </div>
